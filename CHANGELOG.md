...
## What's Changed
* feat(checker): overlay export presets from `export_overrides.cfg` by @coffeebeats in https://github.com/coffeebeats/godot-infra/pull/644


**Full Changelog**: https://github.com/coffeebeats/godot-infra/compare/v6.14.1...v6.15.0
...
## What's Changed
* feat(plugins): own the translation catalogue tooling by @coffeebeats in https://github.com/coffeebeats/godot-infra/pull/637


**Full Changelog**: https://github.com/coffeebeats/godot-infra/compare/v6.12.1...v6.13.0
...
## What's Changed
* feat(plugins): add a 'godot' agent plugin with the shared project checker by @coffeebeats in https://github.com/coffeebeats/godot-infra/pull/618


**Full Changelog**: https://github.com/coffeebeats/godot-infra/compare/v6.5.1...v6.6.0
...
## What's Changed
* feat(workflows): serve addons from 'check-project' and leave aggregates to callers by @coffeebeats in https://github.com/coffeebeats/godot-infra/pull/592


**Full Changelog**: https://github.com/coffeebeats/godot-infra/compare/v6.0.0...v6.1.0
...
* fix(package-addon): add `.godot-infra` to package `.gitignore` by @coffeebeats in https://github.com/coffeebeats/godot-infra/pull/535
...
## What's Changed
* fx(ci): skip checkout if already on branch by @coffeebeats in https://github.com/coffeebeats/godot-infra/pull/487


**Full Changelog**: https://github.com/coffeebeats/godot-infra/compare/v3.1.7...v3.1.8
